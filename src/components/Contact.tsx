        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="font-crimson text-4xl lg:text-5xl font-semibold text-foreground mb-6">
              Let's Create
              <span className="text-sage block">Together</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8 animate-fade-in">
              <div>
                <h3 className="font-crimson text-2xl font-medium text-foreground mb-4">
                  Get in Touch
                </h3>
            ...
            <div className="animate-fade-in">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-sage text-white py-3 px-6 rounded-sm hover:bg-sage/90 transition-colors duration-300 font-medium"
                >
                  Send Message
                </button>
              </form>
